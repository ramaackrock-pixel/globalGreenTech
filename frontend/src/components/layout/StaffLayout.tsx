    ...
    <div className="flex h-screen bg-[#f8fafc] text-slate-800 font-sans text-sm selection:bg-primary-500/30">
      ...
      <aside className="w-64 hidden md:flex flex-col relative overflow-hidden shadow-[8px_0_40px_rgba(0,135,62,0.08)] z-20 border-r border-white/40">
        ...
        <nav className="flex-1 py-6 overflow-y-auto relative z-10">
          <div className="px-6 mb-3 text-[10px] font-extrabold text-slate-500/80 uppercase tracking-widest drop-shadow-[0_1px_1px_rgba(255,255,255,1)]">Field Operations</div>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <header className="h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 flex items-center justify-between px-6 z-10 shrink-0 sticky top-0 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-sm font-bold text-slate-700 hidden sm:block bg-slate-100 px-3 py-1 rounded-full border border-slate-200">Technician Dashboard</h2>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 cursor-pointer group p-1.5 pr-4 rounded-full hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 text-white flex items-center justify-center border border-primary-400 shadow-sm group-hover:shadow-primary-500/20 transition-all">
                <span className="font-bold text-xs">RK</span>
              </div>
              <span className="text-sm font-bold text-slate-700 hidden sm:block group-hover:text-primary-600 transition-colors">Rahul Kumar</span>
            </div>
          </div>
        </header>
