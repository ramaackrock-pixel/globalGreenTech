...
class StaffSettingsView extends ConsumerStatefulWidget {
  const StaffSettingsView({super.key});

  @override
  ConsumerState<StaffSettingsView> createState() => _StaffSettingsViewState();
}

class _StaffSettingsViewState extends ConsumerState<StaffSettingsView> {
