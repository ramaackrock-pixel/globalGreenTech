...
class CustomerSettingsView extends ConsumerStatefulWidget {
  const CustomerSettingsView({super.key});

  @override
  ConsumerState<CustomerSettingsView> createState() => _CustomerSettingsViewState();
}

class _CustomerSettingsViewState extends ConsumerState<CustomerSettingsView> {
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.key_outlined, color: theme.colorScheme.primary, size: 24),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Column(
